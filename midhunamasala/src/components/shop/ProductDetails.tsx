                ...
                <div className="flex flex-col lg:flex-row">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            {/* Action Buttons */}
                            <motion.div className="flex gap-4" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.85 }}>
                                <motion.button
                                    onClick={handleAddToCart}
                                    disabled={addedToCart}
                                    className={`flex-1 py-3.5 px-6 rounded-xl font-bold flex items-center justify-center gap-2 transition-all duration-300 shadow-lg ${
                                        addedToCart
